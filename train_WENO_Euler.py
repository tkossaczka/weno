...
# divider = 32
# rho_ex_0=rho_ex[0:2048 + 1:divider, 0:2048 + 1:divider]
# u_ex_0=u_ex[0:2048 + 1:divider, 0:2048 + 1:divider]
# p_ex_0=p_ex[0:2048 + 1:divider, 0:2048 + 1:divider]
...
for j in range(20):
    ...
    #init_id = 0 #random.randint(0,sp_st-1)
    #print(init_id)
    # init_id = 60
    ...
    #lamb = lamb.detach()
    base_path ="C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Euler_System_Test/Models/Model_26/"
