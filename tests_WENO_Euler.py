...
train_model = torch.load("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Euler_System_Test/Models/Model_73/1.pt")  # 39/62 works good obtained with old IC, 44/46
