...
with torch.no_grad():
    train_model = torch.load("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/PME_Test/Models/Model_58/190.pt")
...
mean_max = np.mean(order_mat_max_l2[1:5,1])
mean_l2 = np.mean(order_mat_max_l2[1:5,3])
