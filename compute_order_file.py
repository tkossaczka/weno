...
with torch.no_grad():
    ...
    err_trained, order_trained = train_model.order_compute(nb, 10, None,  params, problem, trainable=True)
    err_not_trained, order_not_trained = train_model.order_compute(nb,10,None, params, problem, trainable=False)
