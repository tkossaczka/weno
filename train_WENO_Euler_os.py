...
# rho_ex = torch.Tensor(rho_ex)
# u_ex = torch.Tensor(u_ex)
# p_ex = torch.Tensor(p_ex)
...
for j in range(20):
    ...
    #t = 0.5 * h / lamb
    # for k in range(10):
    #     q_0_train, q_1_train, q_2_train, lamb = train_model.forward(problem_main, method, q_0_train, q_1_train, q_2_train, lamb, k=k, dt=None, mweno=True, mapped=False)
    #     print(k)
    # rho = q_0_train
    # u = q_1_train / rho
    # E = q_2_train
    ...
    #lamb = lamb.detach()
    path = "C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Euler_System_Test/Models/Model_20/{}".format(j)
