...
for j in range(50):
    ...
    problem_main = problem_class(type = "Barenblatt", space_steps=40, time_steps=None, params=params)
    ...
    for k in range(nn):
        ...
        print(j, k, loss)
        u_train.detach_()
    base_path ="C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/PME_Test/Models/Model_6/"
    ...
    for kk in range(1):
        ...
        problem_test = problem_class(type = "Barenblatt", space_steps=40, time_steps=None, params=params_test)
        ...
        with torch.no_grad():
            ...
            u_exact_test = problem_main.exact(T_test, "Barenblatt")
