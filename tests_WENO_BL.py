...
train_model = torch.load("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Buckley_Leverett_CD_Test/Models/Model_12/600.pt") #45/500 #46/650
...
for j in range(rng):
    params = validation_problems_BL(j)
