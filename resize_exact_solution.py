...
for j in range(369):
    ...
    problem_main = problem(sample_id=None, example="boxes", space_steps=128, time_steps=None, params=params)
    ...
    np.save(os.path.join(save_path, "u_exact128_{}".format(j)), u_ex)
